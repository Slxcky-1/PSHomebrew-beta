...
function getPersonalityForTone(tone, username) {
    switch (tone) {
        ...
        case 'joke':
            return { 
                instruction: `The user ${username} made a joke or is being playful. Match their energy! Respond with wit, humor, or friendly banter. Keep it brief (2-3 sentences) but have fun with it.`,
                maxTokens: 80
            };
        ...
        default:
            return { 
                instruction: `The user ${username} is having a casual chat. Give a friendly, helpful response. Be personable and conversational. 3-4 sentences maximum. Light humor or PlayStation references are welcome.`,
                maxTokens: 120
            };
    }
}
