...
async function updateAIKnowledge() {
    try {
        ...
        if (updated) {
            ...
            console.log(`🔗 Live Guides: https://www.psx-place.com/threads/hacking-the-ps4.10717/ | https://www.psx-place.com/ | https://wololo.net/ | https://reddit.com/r/ps4homebrew`);
        }
    } catch (error) {
