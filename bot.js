...
function getPersonalityForTone(tone, username) {
    switch (tone) {
        ...
        case 'joke':
            return { 
                instruction: `The user ${username} made a joke or is being playful. Respond naturally and keep it friendly. Don't force puns or wordplay. Keep it brief (2-3 sentences).`,
                maxTokens: 80
            };
        ...
        default:
            return { 
                instruction: `The user ${username} is having a casual chat. Give a friendly, helpful response. Be personable and conversational. 3-4 sentences maximum. Be natural, not punny.`,
                maxTokens: 120
            };
    }
}
